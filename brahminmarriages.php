...
<main role="main" >
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="images/1.jpg"  width="auto" height="auto" alt="">
              

        <div class="container">
          <div class="carousel-caption text-left">
            <h1>Bhramin Marriage</h1>
            <p>Weddings are fun! Especially when you are not managing anything. 😉
            There are certain common things which happen at every Bhramin wedding, read it and you will definitely connect to it.</p>
...
<img width="140" height="140" src="images/food.jpg" style="border-radius:50%" focusable="false" role="img" aria-label="Placeholder: 140x140"></img>        <h2>Food services</h2>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">Bhramin Wedding customization. <span class="text-muted">choose what you would like on the special day.</span></h2>
      ...
      <div class="col-md-5">
       ...
       <form action="bhthanks.php" method="POST">
